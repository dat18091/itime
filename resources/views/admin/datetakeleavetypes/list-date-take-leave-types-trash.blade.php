...
@section('admin_title')
<title>IZITIME - Danh sách thùng rác loại ngày nghỉ phép</title>
@stop
@section('css')
<?php
            ...
            <div class="card">
                <div class="card-header">
                    <div class="action-button" style="display:flex;">
                        ...
                        <div class="space"><a href="{{URL::to('/admin/list-date-take-leave-types')}}" class="btn btn-danger ">Danh sách </a></div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group group-round m-1">
                                            <a type="button" href="{{URL::to('/admin/restore-date-take-leave-types/'.$datetakeleave->id)}}" class="btn btn-success waves-effect waves-light">Restore</a>
                                            <a type="button" href="{{URL::to('/admin/delete-date-take-leave-types/'.$datetakeleave->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa vùng này vĩnh viễn?')" class="btn btn-danger waves-effect waves-light">Xóa</a>
                                        </div>
                                    </td>
