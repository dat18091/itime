...
@section('admin_title')
<title>IZITIME - Danh sách thùng rác chi nhánh</title>
@stop
@section('css')
<?php
            ...
            <div class="card">
                <div class="card-header">
                    <div class="action-button" style="display:flex;">
                        <div class="space"><a href="" data-toggle="modal" data-target="#themChiNhanh" data-whatever="@mdo" class="btn btn-success ">Tạo mới</a></div>
                        <div class="space"><a href="{{URL::to('/admin/list-branches-trash')}}" class="btn btn-primary ">Thùng rác</a></div>
                        <div class="space"><a href="{{URL::to('/admin/list-branches')}}" class="btn btn-danger ">Danh sách</a></div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group group-round m-1">
                                            <a type="button" href="{{URL::to('/admin/restore-branches/'.$branch->ma_chi_nhanh)}}" class="btn btn-success waves-effect waves-light">Restore</a>
                                            <a type="button" href="{{URL::to('/admin/delete-branches/'.$branch->ma_chi_nhanh)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa chi nhánh này vĩnh viễn?')" class="btn btn-danger waves-effect waves-light">Xóa</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
