                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group group-round m-1">
                                            ...
                                            <a type="button" href="{{URL::to('/admin/delete-areas/'.$area->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa vùng này?')" class="btn btn-danger waves-effect waves-light">Xóa</a>
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
