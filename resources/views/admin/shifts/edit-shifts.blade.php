        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="signupForm" method="post" action="{{URL::to('/admin/update-shifts/'.$shift->id)}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="{{$shift->name}}" id="name" name="name" onkeyup="changeToKeyword();">
                            </div>
                            <label for="input-15" class="col-sm-2 col-form-label">Từ khóa <span class="focus">*</span></label>
                            <div class="col-sm-4">
                                <input type="text" readonly class="form-control" value="{{$shift->keyword}}" id="keyword" name="keyword">
                            </div>
                        </div>
                        <script type="text/javascript">
                            function changeToKeyword() {
                                ...
                                tenCaLam = document.getElementById("name").value;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="4" id="input-17" name="note">{{$shift->note}}</textarea>
                            </div>
                        </div>
