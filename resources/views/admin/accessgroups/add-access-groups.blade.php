...
@section('admin_title')
<title>IZITIME - Thêm nhóm truy cập</title>
@stop
@section('css')
<!-- Vector CSS -->
...
<div class="container-fluid">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            <h4 class="page-title">THÊM NHÓM TRUY CẬP</h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javaScript:void();">Công Ty</a></li>
                <li class="breadcrumb-item active" aria-current="page">Thêm Nhóm Truy Cập</li>
            </ol>
        </div>
        <div class="col-sm-3">
