            ...
            <div class="card">
                <div class="card-header">
                    <div class="action-button" style="display:flex;">
                        ...
                        <div class="space"><a href="{{URL::to('/admin/list-positions-trash')}}" class="btn btn-primary ">Thùng rác</a></div>
                        <div class="space"><a href="{{URL::to('/admin/list-positions')}}" class="btn btn-danger ">Danh sách</a></div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group group-round m-1">
                                            <a type="button" href="{{URL::to('/admin/restore-positions/'.$position->ma_chuc_danh)}}" class="btn btn-success waves-effect waves-light">Restore</a>
                                            <a type="button" href="{{URL::to('/admin/delete-positions/'.$position->ma_chuc_danh)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa chức danh này vĩnh viễn?')" class="btn btn-danger waves-effect waves-light">Xóa</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
