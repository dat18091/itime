...
@section('admin_title')
<title>IZITIME - Danh sách thùng rác chức danh</title>
@stop
@section('css')
<?php
            ...
            <div class="card">
                <div class="card-header">
                    <div class="action-button" style="display:flex;">
                        <div class="space"><a href="{{URL::to('/admin/list-positions-trash')}}" class="btn btn-primary ">Thùng rác <span class="badge badge-warning badge-pill">{{ $positionCount }}</span></a></div>
                        <div class="space"><a href="{{URL::to('/admin/list-positions')}}" class="btn btn-danger ">Danh sách <span class="badge badge-primary badge-pill">{{ $positionCountAllOnl }}</span></a></div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group group-round m-1">
                                            <a type="button" href="{{URL::to('/admin/restore-positions/'.$position->id)}}" class="btn btn-success waves-effect waves-light">Restore</a>
                                            <a type="button" href="{{URL::to('/admin/delete-positions/'.$position->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa chức danh này vĩnh viễn?')" class="btn btn-danger waves-effect waves-light">Xóa</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
