            ...
            <div class="card">
                <div class="card-header">
                    <div class="action-button" style="display:flex;">
                        ...
                        <div><a href="{{URL::to('/admin/list-take-leave-reasons-trash')}}" class="btn btn-primary space">Thùng rác</a></div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{URL::to('/admin/save-take-leave-reasons')}}" id="editForm">
                            {{csrf_field()}}
