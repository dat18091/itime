...
@section('admin_title')
<title>IZITIME - Chỉnh sửa lý do nghỉ phép</title>
@stop
@section('css')
<!-- Vector CSS -->
...
<div class="container-fluid">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            <h4 class="page-title">CHỈNH SỬA LÝ DO NGHỈ PHÉP</h4>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    @foreach($takeleavereasons as $key => $reason)
                    <form method="post" action="{{URL::to('/admin/update-take-leave-reasons/'.$reason->id)}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" style="resize:none;" rows="4" id="input-17" name="note">{{$reason->note}}</textarea>
                            </div>
                        </div>
